  ...
  return `
    ...
    <head>
      <style>
        ...
        .button { display: inline-block; padding: 12px 24px; margin: 20px 0; background-color: #991b1b; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: bold; }
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="details">
            ...
            <a href="${clientPortalUrl}" class="button">Access Your Portal</a>
          </div>
