...
import { auth } from '../firebase'; // Import from central file
...
export default function AgentLogin() {
    ...
    const handleMicrosoftLogin = () => {
        ...
        // This is important for corporate logins
        provider.setCustomParameters({
            // This forces login with a specific company's Azure AD
            // Replace 'YOUR_TENANT_ID' with the Directory (tenant) ID from your Azure app registration
            tenant: '1435da88-703e-449d-9c3d-cf30ba83d326',
        });
        
        signInWithPopup(auth, provider)
            .then((result) => {
                // Login is handled by the onAuthStateChanged listener in App.jsx
            })
            .catch((error) => {
