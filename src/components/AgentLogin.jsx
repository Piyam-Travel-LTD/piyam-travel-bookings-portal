        ...
        <div className="bg-gray-100 min-h-screen flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                <div className="bg-white rounded-2xl shadow-lg p-8">
                    ...
                    <h1 className="text-2xl font-bold text-center text-gray-800 mb-2">Agent Portal Login</h1>
                    <p className="text-gray-500 text-center mb-8">Secure access for authorized agents.</p>
                    
                    <form className="space-y-6">
                        <div>
                            <label htmlFor="email" className="block text-sm font-medium text-gray-700">Corporate Email</label>
                            <div className="mt-1 relative">
                                ...
                                <input 
                                    ...
                                    placeholder="name@piyamtravel.com"
                        ...
                        <div>
                            <label htmlFor="authCode" className="block text-sm font-medium text-gray-700">Authenticator Code</label>
                            <div className="mt-1 relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <div>
                             <button 
                                type="submit" 
                                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-red-800 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
                            >
                                Secure Login
                            </button>
                        </div>
